    ...
    <body>
        <div class="flex-center position-ref full-height" style="background-image: url({{asset('imagenes/ubicanos.jpg')}}); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="row" id="app" style="color: #fff;">
            <h1 style="color: #FEA700;">UBICACIÓN</h1>
                <br/>
        		...
        		<div class="col-lg-5 col-sm-5" style="background-color: #222;opacity: .85;">
        			<h2 style="color: #FEA700;">Nos ubicamos en: </h2>
        			<div class="space"></div>
        			<div class="col-lg-2 col-sm-2">
        				<ul class="list">
        					<h5><img src="{{asset('icono/home.jpg')}}"></h5>
        					<h5><img src="{{asset('icono/telefono.jpg')}}"></h5>
        					<h5><img src="{{asset('icono/cell.jpg')}}"></h5>
        					<h5><img src="{{asset('icono/mensaje.jpg')}}"></h5>
        				</ul>
        			</div>
        			<div class="col-lg-10 col-sm-10">
        				<ul class="list">
        					<h4>Av. Los Heroes 1385 -San Juan de Miraflores - Lima </h4>
        					<h4>(01) 283 1518</h4>
        					<h4>(+51) 994 363 323</h4>
        					<h4>institucionManaguita@gmail.com</h4>
        				</ul>
        			</div>
        		</div>
        	</div>
